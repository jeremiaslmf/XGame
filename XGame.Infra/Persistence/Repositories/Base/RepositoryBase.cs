...
namespace XGame.Infra.Persistence.Repositories.Base
{
        ...
        where TId : struct
    {
        ...
        /// <param name="includeProperties">Informe o array de express~es que deseja incluir</param>
        /// <returns></returns>
        private IQueryable<TEntidade> Include(IQueryable<TEntidade> query, Expression<Func<TEntidade, object>>[] includeProperties)
        {
